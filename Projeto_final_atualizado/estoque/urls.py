...
urlpatterns = [
    ...
    path('tags/listar/', views.TagsTabelaListView.as_view(), name='tags_list'),
    path('tags/<int:pk>/', views.TagsDetailView.as_view(), name='tags_detail'),
    path('tags/novo/', views.TagsCreateView.as_view(), name='tags_create'),
    path('tags/<int:pk>/editar/', views.TagsUpdateView.as_view(), name='tags_update'),
    path('tags/<int:pk>/deletar/', views.TagsDeleteView.as_view(), name='tags_delete'),
