...
class TagsTabelaListView(ListView):
    model = Protuto_Tag
    template_name = 'estoque/tags_tabela_list.html'
...
class TagsDetailView(DetailView):
    model = Protuto_Tag
    template_name = 'estoque/tags_detail.html'
    context_object_name = 'tags'

class TagsCreateView(CreateView):
    model = Protuto_Tag
    template_name = 'estoque/tags_form.html'
    # Lista dos campos que o usuário poderá preencher
    fields = ['identificacao','descricao']
    # URL para onde o usuário será redirecionado após o sucesso
    success_url = reverse_lazy('estoque:tags_list')
...
class TagsDeleteView(DeleteView):
    model = Protuto_Tag
    template_name = 'estoque/tags_confirm_delete.html'
    success_url = reverse_lazy('estoque:tags_list')
    context_object_name = 'tags'
